...
var displayMap = function displayMap(location) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoibmd1eWVubmdvY3BodTAxNjYiLCJhIjoiY2txZ3M5eGE4MHc2ajJvbnpoaTd0bXNkbCJ9.wggEURhqUvGgUecTxDteQA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/nguyenngocphu0166/ckqtpgfej54ew18o0bgw0fsd7/draft' //center: [-74.387161, 40.65034],
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            //console.log(error);
            (0, _alert.showAlert)('error', 'sai mk or email');
...
var stripe = Stripe('pk_test_51JBiPVLRAvZ4hnee5dqzv9evi27qaqel08F3Cynr2514lgyaksNG5mPeHqlrdPigHqnQr1R33fyUNtL8fEugUMxx00jkvGjy0J');
...
if (formUserData) {
  formUserData.addEventListener('submit', function (e) {
    ...
    (0, _updateSetting.update)(form, 'data');
  });
}
...
if (formUserPassword) {
  formUserPassword.addEventListener('submit', function (e) {
    e.preventDefault();
    var password_current = document.getElementById('password-current').value;
